      ...
      <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6 space-y-5">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
          ...
          <div className="divide-y divide-gray-100">
            ...
            <Link href="/2fa/setup" className="flex items-center gap-3 px-5 py-4 hover:bg-gray-50 transition-colors">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-blue-50">
                <ShieldCheck className="h-4 w-4 text-blue-500" />
              </div>
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">Authentification à deux facteurs</p>
                <p className="text-xs text-gray-400">Sécurisez votre compte avec la 2FA</p>
              </div>
              <ChevronRight className="h-4 w-4 text-gray-300" />
            </Link>
