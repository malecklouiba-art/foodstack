...
const navItems: NavItem[] = [
  ...
  { href: '/dashboard/foodstack-demo', label: 'Boutique démo',  icon: Zap,               section: 'Général',        roles: ['admin'] },
  { href: '/dashboard/admin-settings', label: 'Paramètres',     icon: SlidersHorizontal, section: 'Général',        roles: ['admin'] },
