        ...
        {open && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative z-10 w-full max-w-xl overflow-hidden rounded-2xl border border-surface-200 bg-white shadow-2xl"
            >
              {/* Search input */}
              <div className="flex items-center gap-3 border-b border-surface-100 px-4 py-3">
                ...
                />
                <kbd className="hidden rounded-lg border border-surface-200 bg-surface-50 px-1.5 py-0.5 text-[10px] font-medium text-surface-400 sm:block">
                  ESC
                </kbd>
              </div>
                          ...
                          return (
                            ...
                            >
                              <div className={clsx(
                                ...
                                isActive ? 'bg-brand-500/20' : 'bg-surface-100'
                              )}>
                                <Icon className={clsx('h-3.5 w-3.5', isActive ? 'text-brand-600' : 'text-surface-500')} />
                              </div>
                              <span className={clsx('flex-1 text-sm font-medium', isActive ? 'text-brand-700' : 'text-surface-700')}>
                                {item.label}
                              </span>
              ...
              {/* Footer */}
              <div className="flex items-center gap-4 border-t border-surface-100 px-4 py-2.5 text-[10px] text-surface-400">
                <span className="flex items-center gap-1"><kbd className="rounded border border-surface-200 bg-surface-50 px-1 py-0.5 font-mono">↑↓</kbd> naviguer</span>
                <span className="flex items-center gap-1"><kbd className="rounded border border-surface-200 bg-surface-50 px-1 py-0.5 font-mono">↵</kbd> ouvrir</span>
                <span className="flex items-center gap-1"><kbd className="rounded border border-surface-200 bg-surface-50 px-1 py-0.5 font-mono">ESC</kbd> fermer</span>
